...
var Home = function Home(_) {
  ...
  var onTicketSelect = react__WEBPACK_IMPORTED_MODULE_1__["useCallback"](function (i, j) {
    ...
    if (selected[i + "_" + j]) {
      setSelected(__assign(__assign({}, selected), (_a = {}, _a[i + "_" + j] = null, _a.total = selected.total - 1, _a)));
    } else {
      if (selected.total === 6) {
  ...
  var calculatePrice = function calculatePrice(selected) {
    return Object.keys(selected).reduce(function (results, item) {
      if (selected[item]) {
        ...
        return results + meta.detail[tickets];
      }
    }, 0);
  };
...
//# sourceMappingURL=home-home.cf811ca8293e6cdefc89.hot-update.js.map