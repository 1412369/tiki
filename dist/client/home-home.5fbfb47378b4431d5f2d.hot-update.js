...
var Home = function Home(_) {
  ...
  var onTicketSelect = react__WEBPACK_IMPORTED_MODULE_1__["useCallback"](function (i, j) {
    ...
    if (selected[i + "_" + j]) {
      setSelected(__assign(__assign({}, selected), (_a = {}, _a[i + "_" + j] = 0, _a.total = selected.total - 1, _a)));
    } else {
      if (selected.total === 6) {
        return alert('max tickets pick');
      }

      setSelected(__assign(__assign({}, selected), (_b = {}, _b[i + "_" + j] = 1, _b.total = selected.total + 1, _b)));
    }
  }, [selected, state]);
  var _b = state.meta,
      types = _b.types,
  ...
  return react__WEBPACK_IMPORTED_MODULE_1__["createElement"](_home_styled__WEBPACK_IMPORTED_MODULE_2__["HomeContainer"], null, react__WEBPACK_IMPORTED_MODULE_1__["createElement"](_home_styled__WEBPACK_IMPORTED_MODULE_2__["MovieTitle"], null, react__WEBPACK_IMPORTED_MODULE_1__["createElement"]("h2", null, "M\u1EAFt bi\u1EBFc")), react__WEBPACK_IMPORTED_MODULE_1__["createElement"](_home_styled__WEBPACK_IMPORTED_MODULE_2__["TicketWrapper"], null, state.tickets.map(function (item, rowIndex) {
    ...
    className: "move-time"
  }, react__WEBPACK_IMPORTED_MODULE_1__["createElement"]("span", null, location.start), react__WEBPACK_IMPORTED_MODULE_1__["createElement"]("span", null, location.end))), react__WEBPACK_IMPORTED_MODULE_1__["createElement"](_home_styled__WEBPACK_IMPORTED_MODULE_2__["PaymentActions"], null, react__WEBPACK_IMPORTED_MODULE_1__["createElement"]("button", null, "Combo"), react__WEBPACK_IMPORTED_MODULE_1__["createElement"]("button", null, "Thanh to\xE1n")));
};
...
//# sourceMappingURL=home-home.5fbfb47378b4431d5f2d.hot-update.js.map